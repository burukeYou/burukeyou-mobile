<template>
	<view>
		...
		<!-- 2-表单 -->
		<view class="main">
			<view style="border-radius: 2.5rem;box-shadow: 0 0 60rpx 0 rgba(43,86,112,.1);
			padding: 32rpx;width: 77%;height: 36rpx;">
				<input v-model="condition.username" style="font-size: 31rpx;margin-left: 26rpx;" maxlength=11 type="text" placeholder="账号/手机/邮箱" />
			</view>
			
			<view style="border-radius: 2.5rem;box-shadow: 0 0 60rpx 0 rgba(43,86,112,.1);
			padding: 32rpx;width: 77%;height: 36rpx;margin-top: 50rpx;">
				<input v-model="condition.password" style="font-size: 31rpx;margin-left: 26rpx;" maxlength=11 type="password" placeholder="密码" />
			</view>		
		<!-- 	<input maxlength=11 type="password" placeholder="密码" /> -->
		</view>
			
		<!-- 3-登陆按钮 -->
		<button @click="toLogin" class="bk-background-color " 
		...
		<!-- 4-第三方登陆 -->
		<view class="flex-all-center" style="margin-top: 195rpx;">
			<view class="iconfont iconQQdenglu"></view>
			<view class="iconfont iconqrcode" @click="otherLogin" style="padding-top: 16rpx;"></view>
			<view class="iconfont icongithub"></view>
		</view>
		
		<!-- 5-底部信息-->
		<view  class="flex-all-center footer text-light-muted">
			<navigator url="forget" open-type="navigate">忘记密码</navigator>
			<text>|</text>
			<navigator url="/pages/my/login/register" open-type="navigate">注册账号</navigator>
		</view>
