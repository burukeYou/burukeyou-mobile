	...
	<view>
		...
		<view class="main">
			...
			padding: 32rpx;width: 77%;height: 36rpx;">
				<input v-model="account" style="font-size: 31rpx;margin-left: 26rpx;" maxlength=11 type="text" placeholder="账号/手机/邮箱" />
			</view>
			
			<view style="border-radius: 2.5rem;box-shadow: 0 0 60rpx 0 rgba(43,86,112,.1);
			padding: 32rpx;width: 77%;height: 36rpx;margin-top: 50rpx;">
				<input v-model="password" style="font-size: 31rpx;margin-left: 26rpx;" maxlength=11 type="password" placeholder="密码" />
			</view>		
...
<script>
	...
	export default {
		...
		methods: {
			// 1 -  登陆
			toLogin(){
				console.log("执行登陆:"+this.account +":"+this.password)
		...
		computed:{
			validationInput(){
				return this.account === '' || this.password === '' ? false : true
			}
		}
	}
</script>
