...
var divider = function divider() {__webpack_require__.e(/*! require.ensure | bkcomponents/divider */ "bkcomponents/divider").then((function () {return resolve(__webpack_require__(/*! ./bkcomponents/divider */ 204));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('divider', divider); //   =================  2- 引入自定义全局js依赖    ========================================
...
_vue.default.prototype.$auth = function (callback) {// 
  if (!_index2.default.state.loginStatus) {uni.navigateTo({ url: "/pages/my/login/login" });
